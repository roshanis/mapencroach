      ...
      >
        <span
          className={`h-3.5 w-3.5 rotate-12 rounded-[3px] border-2 ${
            inverse ? "border-blue-200" : "border-gov"
          }`}
        />
        <span className="absolute right-1.5 top-1.5 h-1.5 w-1.5 rounded-full bg-[#ec8e32]" />
      </span>
      <span className="text-[15px] font-semibold tracking-wide">mapencroach</span>
    </span>
  );
}
...
function HeroConsolePreview() {
  return (
    ...
    >
      <div className="absolute -inset-5 -z-10 rounded-[2rem] bg-gov/15 blur-3xl" />
      <div className="overflow-hidden rounded-[1.35rem] border border-white/70 bg-white shadow-[0_30px_90px_rgba(15,23,42,0.18)]">
        <div className="flex h-11 items-center justify-between border-b border-gray-200 bg-gov px-4 text-white">
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-blue-200 shadow-[0_0_0_4px_rgba(191,219,254,0.18)]" />
        ...
        <div className="grid min-h-[390px] grid-cols-[150px_1fr] sm:grid-cols-[190px_1fr]">
          <div className="border-r border-gray-200 bg-gray-50 p-3">
            ...
            <div className="mt-3 rounded-lg border border-[#f1c9bd] bg-white p-3 shadow-sm">
              ...
              <p className="mt-2 text-[11px] font-semibold text-gray-900">SN-101</p>
            ...
            <div className="mt-2 rounded-lg border border-[#eadac1] bg-white p-3">
              ...
              <p className="mt-2 text-[11px] font-semibold text-gray-900">SN-103</p>
              <p className="mt-1 text-[9px] text-gray-500">Forest · Grade C</p>
            </div>
          ...
          <div className="landing-map relative overflow-hidden bg-slate-200">
            ...
            <div className="absolute bottom-4 right-4 w-[172px] rounded-xl border border-gray-200 bg-white/95 p-3 shadow-lg backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <span className="text-[9px] font-bold text-[#a82d1d]">URGENT ALERT</span>
                <span className="text-[9px] text-gray-500">ALT-001</span>
              </div>
      ...
      <div className="absolute -bottom-6 left-6 hidden rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-xl sm:block">
        <p className="text-[9px] font-semibold uppercase tracking-[0.14em] text-gov">
          Next lawful action
        </p>
        <p className="mt-1 text-xs font-semibold text-gray-900">Assign inspection</p>
      </div>
    </div>
  );
}
...
export default function LandingPage() {
  return (
    <div
      ...
      className="min-h-screen overflow-x-hidden bg-gray-100 text-gray-900"
    >
      <header className="sticky top-0 z-50 border-b border-gray-200/90 bg-gray-100/90 backdrop-blur-xl">
        <div className="mx-auto flex h-[68px] max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link
            href="/"
            aria-label="mapencroach home"
            className="rounded-lg focus:outline-none focus:ring-2 focus:ring-gov focus:ring-offset-4"
          >
            <BrandMark />
          </Link>
          <nav aria-label="Landing" className="hidden items-center gap-7 md:flex">
            ...
            <a className="text-sm font-medium text-gray-600 hover:text-gray-900" href="#product">
              Product
            </a>
            <a className="text-sm font-medium text-gray-600 hover:text-gray-900" href="#trust">
              Trust model
            </a>
          </nav>
          <Link
      ...
      <main>
        <section className="landing-grid relative border-b border-gray-200 px-5 pb-20 pt-14 sm:px-8 sm:pb-28 sm:pt-20 lg:pt-24">
          <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.92fr_1.08fr] lg:gap-12 xl:gap-20">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/75 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-gov shadow-sm">
                <span className="h-1.5 w-1.5 rounded-full bg-[#ec8e32]" />
                Public land intelligence · built for government
              </div>
              <h1 className="mt-7 max-w-3xl text-4xl font-semibold leading-tight tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <a
                  href="#how-it-works"
                  className="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white/70 px-6 py-3.5 text-sm font-semibold text-gray-700 transition hover:border-gray-400 hover:bg-white focus:outline-none focus:ring-2 focus:ring-gov focus:ring-offset-2"
                >
                  See how it works
                </a>
              </div>
              <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs font-medium text-gray-600">
                <span className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-gov" />
                  Jurisdiction-scoped
                </span>
                <span className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-gov" />
          ...
          <dl className="mx-auto mt-20 grid max-w-7xl grid-cols-2 overflow-hidden rounded-2xl border border-gray-200 bg-white/70 shadow-[0_16px_45px_rgba(15,23,42,0.06)] backdrop-blur sm:grid-cols-4">
            {DEMO_METRICS.map((metric, index) => (
              ...
              >
                <dd className="text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl">
                  {metric.value}
                </dd>
                <dt className="mt-1 text-xs font-medium text-gray-500 sm:text-sm">
                  {metric.label}
                </dt>
              </div>
            ))}
          </dl>
          <p className="mx-auto mt-3 max-w-7xl text-right text-[10px] uppercase tracking-[0.12em] text-gray-500">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-14 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {WORKFLOW_STEPS.map((step, index) => (
                <article
                  key={step.number}
                  className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 p-6 transition hover:-translate-y-1 hover:border-gov/30 hover:shadow-[0_16px_40px_rgba(15,23,42,0.08)]"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold uppercase tracking-[0.16em] text-gov">
                      {step.label}
                    </span>
                    <span className="text-sm font-semibold text-gray-400">{step.number}</span>
                  </div>
                  <div className="mt-8 h-10 w-10 rounded-full border border-blue-200 bg-white p-2">
                    <div className="h-full w-full rounded-full bg-gov" style={{ opacity: 0.25 + index * 0.2 }} />
                  </div>
        ...
        <section id="product" className="scroll-mt-24 border-y border-gray-200 bg-gray-100 px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto max-w-7xl">
            <div className="grid items-end gap-6 lg:grid-cols-[1fr_0.65fr]">
              <div>
                ...
                <h2 className="mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
            ...
            <div className="mt-14 grid gap-5 lg:grid-cols-3">
              {CAPABILITIES.map((capability, index) => (
                <article
                  ...
                  className={`rounded-[1.5rem] border border-gray-200 bg-white p-7 shadow-[0_14px_40px_rgba(15,23,42,0.05)] ${
                ...
                >
                  ...
                  <h3 className="mt-7 text-xl font-semibold leading-7 tracking-tight text-gray-900">
                    {capability.title}
                  </h3>
                  <p className="mt-4 text-sm leading-6 text-gray-600">
                    {capability.description}
                  </p>
                  <div className="mt-8 border-t border-gray-200 pt-4 text-xs font-semibold text-gray-700">
                    {capability.detail}
                  </div>
                </article>
              ))}
        ...
        <section id="trust" className="scroll-mt-24 bg-gov-dark px-5 py-20 text-white sm:px-8 sm:py-28">
          <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="rounded-[1.5rem] border border-white/15 bg-white/[0.06] p-5 shadow-2xl backdrop-blur sm:p-7">
              <div className="grid gap-4 sm:grid-cols-[1fr_auto_1fr] sm:items-center">
                <div className="rounded-xl border border-blue-200/25 bg-blue-200/10 p-5">
                ...
                <div className="rounded-xl border border-[#f1a55b]/25 bg-[#f1a55b]/10 p-5">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[#f5b878]">
                    Enforcement layer
                  </p>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-4 md:grid-cols-3">
              {ROLE_CARDS.map((card, index) => (
                <article key={card.role} className="rounded-2xl border border-gray-200 bg-gray-50 p-6">
                  <span className="grid h-9 w-9 place-items-center rounded-full bg-blue-50 text-xs font-semibold text-gov">
                    {index + 1}
                  </span>
                  <h3 className="mt-6 text-lg font-semibold text-gray-900">{card.role}</h3>
                  <p className="mt-3 text-sm leading-6 text-gray-600">{card.focus}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section className="px-5 pb-20 sm:px-8 sm:pb-28">
          <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-blue-50 px-6 py-12 text-center sm:px-12 sm:py-16">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gov">
              Explore the working demonstration
            </p>
            <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
